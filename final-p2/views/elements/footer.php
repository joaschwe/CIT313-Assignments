   ...
   <script src="<?php echo BASE_URL?>views/js/jquery-validation-1.17.0/dist/jquery.validate.js"></script>
   <script src="<?php echo BASE_URL?>views/js/jquery-validation-1.17.0/dist/additional-methods.js"></script>
   <script src="<?php echo BASE_URL?>views/js/site.js"></script>
