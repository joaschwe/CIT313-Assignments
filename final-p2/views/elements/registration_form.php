<form id="registration_form" action="<?php echo BASE_URL;?>register/<?php echo $task?>" method="post" name="signupForm">
...
<input type="password" class="txt" id="cpassword" name="cpassword" value="<?php echo $password;?>" maxlength="100" required="cpassword" />
